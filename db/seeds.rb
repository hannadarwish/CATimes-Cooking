...
ApplicationRecord.transaction do 
    ...
    Recipe.create!(
      ...
      ingredients: '{"result": ["1½ pounds fresh strawberries, hulled",
      ...
      preparation: '{"result": ["Fill a small saucepan with about 1 inch of water and set over medium heat until the water steams.", "Meanwhile, coarsely chop about a quarter of the strawberries and combine in a medium heatproof bowl with the sugar. Cover the bowl tightly and set it over the saucepan. Reduce the heat if necessary to keep the water just below a simmer and allow the berries to sit, swirling the bowl once or twice to dissolve any stubborn sugar clumps, until they’ve released all their juices, are mushy, and swim in a translucent red liquid, 35 to 45 minutes. Remove the bowl from the heat, uncover and strain through a fine-mesh strainer. (You should have ½ to ¾ cup of strawberry syrup.) The mushy berries will have given off their color and flavor, and even though you won’t use them in the cake, they’re still tasty. Reserve the berries for spooning over pancakes or yogurt.",
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield:
      About 60 servings", "FOR THE VANILLA CHIFFON CAKE", "12 large cold eggs", "1 cup/240 grams neutral oil, like grapeseed", "2 tablespoons vanilla extract", "4 cups/800 grams granulated sugar", "3½ cups/480 grams all-purpose flour", "2 tablespoons plus 2 teaspoons baking powder", "2 teaspoons kosher salt (such as Diamond Crystal) or 1 teaspoon fine sea salt", "FOR THE SESAME CRUNCH",
    "Nonstick cooking spray", "4 large egg whites", "½ packed cup/120 grams light brown sugar", "1 teaspoon vanilla extract", "½ teaspoon kosher salt (such as Diamond Crystal) or ¼ teaspoon fine sea salt", "1¾ cups/226 grams toasted white sesame seeds",
  "FOR THE CHARRED CITRUS COMPOTE", "2 large navel oranges", "3 lemons or Meyer lemons", "1½ cups/300 grams granulated sugar", "½ teaspoon citric acid, plus more to taste", "FOR THE CHARRED CITRUS SOAK", "½ cup/120 grams fresh lemon juice",
"⅓ cup/70 grams granulated sugar", "FOR THE TOASTED SESAME BUTTERCREAM", "12 large egg whites", "3 cups/600 grams granulated sugar", "1 cup/150 grams confectioners’ sugar", "1 tablespoon vanilla extract", "1 teaspoon kosher salt (such as Diamond Crystal) or ½ teaspoon fine sea salt, plus more if needed", 
"2 pounds/912 grams unsalted butter, cut into tablespoons, at room temperature", "1 tablespoon toasted sesame oil", "1 cup/240 grams tahini", "TO DECORATE", "Assortment of fresh citrus, such as small tangerines, lemons and kumquats, washed and scrubbed", 
"Fresh food-safe greenery, such as bay leaves or olive branches" ],
      preparation: ["PREPARE THE CHIFFON CAKE LAYERS", "Heat oven to 350 degrees. Line the bottoms of 3 half-sheet pans (13-by-18-by-1-inch) with sheets of parchment.", "Carefully crack eggs into a bowl without breaking the yolks. Pluck out yolks one at a time with clean fingertips, transferring to a large bowl. Transfer the egg whites to the bowl of a stand mixer; set aside. To yolks, add 1 cup/240 grams water, the oil, vanilla and 3 cups/600 grams granulated sugar; whisk until smooth.", " In a very large bowl, whisk flour, baking powder and salt. Pour yolk mixture into dry ingredients and gently stir to combine. (Small lumps are OK.)",
...
"Transfer citrus to a cutting board to cool. Add 8 cups water to the pot, scrape the bottom and bring water to a simmer.", "Peel the fruit, and reserve citrus segments. (You should have about 2 cups segments.) Roughly chop peels.",
"Add chopped peels to the simmering water and simmer, stirring occasionally, until peels are tender, 10 to 15 minutes. Drain peels in a colander, discarding the water.", "Press citrus segments through a strainer into a small bowl to yield ½ cup juice. Set juice aside for the charred citrus soak (see Make the Citrus Soak).",
...
"WHEN READY TO SERVE, CUT THE CAKE", "Using a chef’s knife, cut the 8-inch cake into thirds by making two parallel slices, then cut crosswise into 1-inch-thick pieces, wiping the knife clean between each new cut. Cut the 10-inch cake into quarters by making three parallel slices, then cut those pieces crosswise into 1-inch-thick pieces. The 8-inch cake yields about 24 small slices; the 10-inch cake about 36 slices." ],
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 12 to 14 servings.", "FOR THE CAKE", "2 sticks (226 grams) unsalted butter, at room temperature (plus more for the pan)", "⅔ cup (56 grams) unsweetened cocoa powder (plus more for the pan)", "2 cups (272 grams) all-purpose flour", "1½ teaspoons baking powder",
    "½ teaspoon baking soda", " ½ teaspoon fine sea salt", "1¼ cups (250 grams) sugar", "4 large eggs, at room temperature", "2 teaspoons pure vanilla extract", "1 cup (240 ml.) buttermilk, well shaken",
  "4 ounces (113 grams) bittersweet chocolate, melted and cooled", "FOR THE FROSTING", "3⅓ cups (405 grams) confectioners’ sugar", "4½ tablespoons unsweetened cocoa powder",
"½ teaspoon fine sea salt", "3 sticks (339 grams) unsalted butter, at room temperature", "6 ounces (170 grams) bittersweet chocolate, melted and cooled", "4½ tablespoons buttermilk",
...
"If necessary, just before you’re ready to frost the cakes, slice a sliver off the top of each layer to create a flat surface. To assemble, place one cake layer, top up, on a serving platter, and cover with frosting. Top with the second layer, top down, jiggling it into the frosting to hold it in place. Frost the top and sides of the cake — go sleek or swirly. If you’re using decorations, scatter them over the cake. Chill for at least 1 hour (or for up to 1 day); bring to room temperature before serving."],
    ...
    Recipe.create!(
      ...
      ingredients: ["One 9-inch cake", " ½ cup/115 grams butter, at room temperature, plus 2 tablespoons to prepare pans", "3 tablespoons/20 grams cocoa powder, divided", "1½ cups/300 grams granulated sugar",
    "2 eggs", "2 teaspoons/10 milliliters vanilla extract", "2 tablespoons/30 milliliters red food coloring", "1 teaspoon/6 grams salt", "1 teaspoon/5 grams baking soda", " 2½ cups/320 grams flour, sifted",
  "1 cup/240 milliliters whole buttermilk", "1 tablespoon/15 milliliters vinegar", "Ermine icing (see recipe), or other fluffy white icing"], 
...
"To assemble, remove 1 cake from its pan and place flat side down on a serving platter. Drop about 1 cup of icing onto cake and, using a flat spatula, spread evenly over top. Remove the second cake from its pan. Place flat side down on top of first layer. Use remaining frosting to cover top and sides of cake."], 
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 10 to 12 servings", "FOR THE CAKE", "2½ cups plus 2 tablespoons/330 grams cake flour", "1½ teaspoons baking powder", "1½ teaspoons baking soda", "1¾ cups/350 grams granulated sugar",
    "1 cup/225 grams unsalted butter, softened", "1 tablespoon cinnamon", "1½ teaspoons ground cardamom", "¼ teaspoon freshly grated nutmeg", "¼ teaspoon ground allspice", "1 teaspoon kosher salt",
  "3 large eggs, at room temperature", "2 teaspoons vanilla extract", "2½ cups/610 grams pumpkin purée, at room temperature", "FOR THE CARAMEL SAUCE", "1 cup/200 grams granulated sugar", "2 tablespoons unsalted butter, softened",
"¾ cup/180 milliliters heavy cream, at room temperature", "1 tablespoon whiskey or 2 teaspoons vanilla extract", "½ teaspoon kosher salt", "FOR THE BUTTERCREAM", "4 large egg whites", "1 cup/200 grams granulated sugar",
"2 cups/450 grams unsalted butter, softened and cut into tablespoons", "Pinch of kosher salt"],
      preparation: ["Heat oven to 350 degrees. Butter three 8-inch cake pans and line the bottoms with parchment paper. Flour the pans and paper.", "Sift the flour, baking powder and baking soda into a large bowl.",
...
"Spread the remaining buttercream in an even layer over the cake. If you’d like to add a caramel drizzle, refrigerate the fully frosted cake until firm then carefully spread about ⅓ cup of room temperature caramel sauce over the top of the cake. Use an offset spatula to gently ease it towards the edges so it drips down the sides. Serve at room temperature. Store leftover cake in the refrigerator, but bring to room temperature before serving. Leftover caramel sauce can be stored in an airtight container in the refrigerator"],
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 12 servings", "FOR THE CAKE", "Nonstick baking spray", "3¾ cups/480 grams all-purpose flour", "2 teaspoons ground cinnamon", "1 teaspoon baking soda", "1 teaspoon kosher salt",
    "3 large eggs, at room temperature", "1½ cups/340 grams overripe mashed bananas (about 3 bananas)", "1 packed cup/220 grams dark brown sugar", "1 cup/200 grams granulated sugar", "1 cup/240 milliliters vegetable oil",
  "2 teaspoons vanilla extract", "2 (8-ounce/227-gram) cans crushed pineapple in juice (about 1¾ cups)", "¾ cup/85 grams chopped toasted pecan halves", "FOR THE FROSTING",
"2 (8-ounce/226-gram) packages cream cheese, at room temperature", "1 cup/225 grams unsalted butter (2 sticks), at room temperature", " 7⅓ cups/905 grams confectioners’ sugar", "4 teaspoons vanilla extract",
...
"Place whole toasted pecan halves around the rim of the cake. Garnish with the dried pineapple and edible flowers, as desired. Slice and serve."],
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 4 to 6 servings", "2 lemons, juiced", " ½ cup plus 1 tablespoon olive oil", "6 cloves garlic, peeled, smashed and minced", "1 teaspoon kosher salt", "2 teaspoons freshly ground black pepper",
    "2 teaspoons ground cumin", "2 teaspoons paprika", "½ teaspoon turmeric", "A pinch ground cinnamon", "Red pepper flakes, to taste", "2 pounds boneless, skinless chicken thighs",
  "1 large red onion, peeled and quartered", "2 tablespoons chopped fresh parsley"],
  ...
  "Put the chicken in the oven and roast until it is browned, crisp at the edges and cooked through, about 30 to 40 minutes. Remove from the oven, allow to rest 2 minutes, then slice into bits. (To make the chicken even more crisp, set a large pan over high heat, add a tablespoon of olive oil to the pan, then the sliced chicken, and sauté until everything curls tight in the heat.) Scatter the parsley over the top and serve with tomatoes, cucumbers, pita, white sauce, hot sauce, olives, fried eggplant, feta, rice — really anything you desire."], 
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 4 servings", "FOR THE SPICY SOY DRESSING", "¼ cup soy sauce", "1 tablespoon rice vinegar", "1 tablespoon sesame oil", "1 tablespoon chile oil",
    "2 teaspoons granulated sugar", "1 tablespoon toasted white sesame seeds", " 1 scallion, green and white parts, finely sliced", "FOR THE TOFU",
  "2 (14-ounce) blocks silken tofu, cold", "1 scallion, green and white parts, thinly sliced", "Handful of cilantro leaves"], 
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield:4 servings", "FOR THE DASHI", "20 grams/about 2 (4-inch) squares kombu", "20 grams/about 2 cups loosely packed katsuobushi (dried bonito flakes)",
    "FOR THE BEEF", "1 pound thinly shaved beef", "1 small yellow onion, thinly sliced", "1 bunch scallions, white parts cut into 2-inch segments and halved lengthwise, light green parts thinly sliced at a sharp angle",
  "1 tablespoon granulated sugar", "¼ cup sake", "2 tablespoons soy sauce", "2 tablespoons mirin", "FOR SERVING", "2 tablespoons soy sauce, plus more as needed", "3 tablespoons mirin, plus more as needed",
"1 pound fresh or frozen udon noodles", "Shichimi or nanami togarashi, or use your favorite chile powder (optional)"], 
  ...
  "As beef cooks, bring a pot of unsalted water to a boil — udon noodles are typically made with plenty of salt in the dough — and cook the udon noodles according to package directions.", "To serve, add the soy sauce and mirin to the reserved dashi and stir. Taste and adjust seasoning to taste with more soy sauce or mirin. (The broth should have a balanced savory-sweet flavor.)",
...
"If you prefer, you can turn this recipe into gyudon (Japanese beef and rice bowls): Omit the noodles and broth (making only enough dashi to cook the beef) and serve the cooked beef mixture on top of bowls of steamed white rice. Garnish with beni shoga (pickled red ginger) and a poached or fried egg."], 
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 2 servings", "8 ounces fresh or thawed frozen tteok (see note)", "4 ounces beefsteak, such as chuck or sirloin, very thinly sliced", "½ teaspoon soy sauce",
    "2 teaspoons sesame oil", "2 cloves garlic, minced", "1 small onion, thinly sliced", "2 cups green cabbage, cut crosswise into large pieces (optional)", "1 to 2 tablespoons gochujang (Korean chile paste)",
  "1 to 2 teaspoons sugar", "2 scallions, cut into 1-inch batons", "Sesame seeds"], 
      preparation: ["Soak tteok in cold water to cover while preparing the other ingredients, about 10 minutes. Drain on paper towels.", "Combine beef with soy sauce, 1 teaspoon sesame oil and garlic.",
  ...
  "Mix in scallions and serve hot, sprinkled with sesame seeds.", "TIP", "Tteok (Korean rice cakes, also spelled dduk or toppoki) are available in Asian markets. For this dish, the traditional shape is long cylinders; cut them crosswise in half before cooking. If using dried tteok, cook according to package directions and do not soak."], 
      meal_category: "Sides",
      org_category: "Trending Recipes",
      author: "Julia Moskin",
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield:6 appetizer spread servings, 4 salad servings", "¼ cup fine bulgur wheat", "1 small garlic clove, minced (optional)", "Juice of 2 large lemons, to taste",
    "3 cups chopped fresh flat-leaf parsley (from 3 large bunches)", "¼ cup chopped fresh mint", "½ pound ripe tomatoes, very finely chopped", "1 bunch scallions, finely chopped",
  "Salt, preferably kosher salt, to taste", "¼ cup extra virgin olive oil", "1 romaine lettuce heart, leaves separated, washed and dried"], 
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 8 servings", "2 tablespoons unsalted butter, plus more for greasing the pan", "1 cup quick-cooking polenta", "½ teaspoon fine sea salt", "1 cup whole milk",
    "½ cup/2 ounces fontina or mozzarella, or a blend, shredded", "5 ounces thinly sliced cured meat, such as hot or sweet Italian sausage, salami or ham (optional)",
  "1 packed cup spinach, kale or other leafy green, torn or chopped (optional)", "8 large eggs", "½ cup/2 ounces grated Parmesan", "Ground black pepper",
"¼ cup packed basil leaves, larger ones roughly torn (optional)"],
      preparation: ["Heat oven to 400 degrees with the rack in the center. Generously butter a 9-by-13-inch pan and set aside.", "Bring 4 cups water to a boil. Gradually whisk in the polenta and salt, and cook, stirring constantly until the polenta bubbles and pulls away from the pan, about 3 minutes. Vigorously stir in the milk, butter and cheese until smooth and creamy. (It will seem loose.)",
    ...
    Recipe.create!(
      ...
      ingredients: ["Yield: 8 to 10", "FOR THE DRESSING", "3 tablespoons red wine vinegar, plus more to taste", "1 garlic clove, finely grated or minced", "1 teaspoon dried oregano",
    "Salt and freshly ground black pepper", "⅓ cup extra-virgin olive oil, plus more for drizzling", "FOR THE PASTA", "1 pound short-cut pasta, such as farfalle",
  "1 pint cherry or grape tomatoes, halved", "8 ounces mozzarella, cubed (or use small mozzarella balls)", "4 ounces sliced salami, cut into ¼-inch ribbons", "¾ cup sliced Kalamata olives",
"½ cup thinly sliced cucumber", "3 tablespoons diced red onion", "1 cup coarsely chopped fresh parsley and basil leaves"],
