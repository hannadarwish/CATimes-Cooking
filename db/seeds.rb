...
ApplicationRecord.transaction do 
    ...
    Recipe.create!(
      ...
      ingredients: "1½ pounds fresh strawberries (hulled), ½ cup/100 grams granulated sugar, 1 cup/240 grams heavy cream (chilled), 1 cup/240 grams crème fraîche, mascarpone or sour cream (chilled),
